...
public class ignorMaster {
	...
	protected static String ignorSlashComment(String line) {
		return line.split(Pattern.quote("//"))[0];
	}

	protected static String ignorStarComment(String line) {
	...
	protected static boolean ignorHeader(String line) {
