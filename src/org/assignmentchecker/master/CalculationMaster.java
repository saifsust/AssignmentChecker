...
import org.assignmentChecker.algorithm.LongestCommonSubsequence;
import org.assignmentChecker.algorithm.MarksCalculationMaster;
import org.assignmentchecker.models.Pair;
...
public class CalculationMaster {
	...
	public static void main(String[] args) {
		 ...
		 */
		instance.information = getObservableList("dataStores",0.0, 5, 20);
		for (int i = 0; i < instance.information.size(); i++) {
			System.out.println( instance.information.get(i).getRegNum()+"  "+instance.information.get(i).getCopy() + " " + instance.information.get(i).getMarks());
		}
		clear();
	}
